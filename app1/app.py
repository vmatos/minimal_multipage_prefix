...
bp_registry = {}
bp_registry['page1'] = {'bp': page.make_blueprint('page1', 'App1 - Page 1 title'), 'label': 'Page 1', 'path': 'page1'}
bp_registry['page2'] = {'bp': page.make_blueprint('page2', 'App1 - Page 2 title'), 'label': 'Page 2', 'path': 'page2'}
default_bp = 'page1'

def generate_navbar():
    children = [html.H4('App 1')]
